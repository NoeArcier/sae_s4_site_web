<?php
     ...
     * @return bool
     */
    function verifNomSalle($pdo, $nomSalle, $idSalle) {
     ...
     * @return void
     */
    function creationSalle($pdo, $nomSalle, $capacite, $videoProjecteur, $ordinateurXXL, $nbrOrdi, $typeMateriel, $logiciel, $imprimante){
     ...
     * @return mixed|null
     */
    function recupAttributSalle($pdo, $idSalle) {
     ...
     * @return string
     */
    function mettreAJourSalle($pdo, $idSalle, $nomSalle, $capacite, $videoProjecteur, $ordinateurXXL, $nbrOrdi, $typeMateriel, $logiciel, $imprimante): string {
     ...
     * @return array
     */
    function listeDesCapacites($pdo) {
     ...
     * @return array
     */
    function listeDesOrdinateurs($pdo) {
     ...
     * @return array
     */
    function listeDesLogiciels($pdo) {
     ...
     * @return array
     */
    function supprimerSalle($pdo, $id_salle) {
     ...
     * @return array
     */
    function verifierReservations($pdo) {
